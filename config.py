...
# COMMON_PORTS = [80] # HTTP mode go brrr
...
CONFIG = {
    # "max_threads": 2000, # Max number of threads to use
    "port_scan_threads": len(COMMON_PORTS), # Total threads to scan ports
    "host_scan_threads": 800, # Total threads to scan hosts
...
# CONFIG["host_scan_threads"] = int(round(CONFIG["max_threads"] / CONFIG["port_scan_threads"], 0)) # Calculate the number of threads to scan hosts